...
module.exports = class setCompetence extends SlashCommandBuilder {
    constructor() {
        super();
        this.name = 'umnc-set-competence';
        this.description = "la commande vous ajoute/met à jour vos competences";
